...
```
Partition the data into training and testing datasets. What percentage of training data will you use?
...
4. Use a decision tree (CART) to classify your data. Don’t forget to show your tree. Classify your train and test data. Show the confusion matrix of the results of the model on training data and testing data.
Run the ROC graph and calculate AUC. Interpet your ROC graph and the calculated AUC. Please also discuss the threshold of the probability that you think is appropriate to use for this data. (50
points)
...
5. Adjust a hyperparameter to tune your CART model. Explain which parameter you will tune and why
you chose it. Generate results for your new model and compare and contrast them with your original
...
6. Use a random forest model to classify your data using the original formula. Which variables are the
most important variables in predicting? Classify your training data and testing data. After that,
you need to create a confusion matrix, and calculate accuracy, precision, and recall. Run the ROC
graph and calculate AUC. Interpret your ROC graph and the calculated AUC. Please also discuss the
threshold of the probability that you think is appropriate to use for this data.
```{r}
...
7. Adjust a hyperparameter to tune your RF model. Explain which parameter you will tune and why
you chose it. Generate results for your new model and compare and contrast them with your original
...
To compare the performance across all the different models, which evaluation metric (accuracy, precision,
and recall) will be used to evaluate the models. Why do you pick this measure?
...
Use the measure you chose in Question 9 to compare the performance of the different models. If we
compare the performance based only on training data, which model performs the best? Create a
table that shows all measures in 1 graphic
